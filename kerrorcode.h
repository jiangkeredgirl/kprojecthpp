...
#define ERRORCODE_NIRDEVICE_USBTYPE_USB2                403  // 红外设备接USB2.0
...
#define ERRORCODE_CV_ERROR_IRSEG_TIEHE_COLLISION         905  // 血管贴合位置有碰撞风险
...
const map<int, int> g_erorr_code_level = 
{
    ...
    ,{ERRORCODE_NIRDEVICE_USBTYPE_USB2,                 ERROR_LEVEL_WARN}
    ...
    ,{ERRORCODE_CV_ERROR_IRSEG_INVALID_IR,              ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_IRSEG_INVALID_DEPTH,           ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_IRSEG_WRONG_ROI,               ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_IRSEG_NO_VISIABLE_VESSEL,      ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_IRSEG_NO_FITABLE_VESSEL,       ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_IRSEG_TIEHE_COLLISION,         ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USCONTCAT_INVALID_COPULANT,    ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USCONTCAT_INVALID_BUTTOM,      ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USSEG_NO_VESSEL,               ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USSEG_NO_RELIABLE_VESSEL,      ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USSEG_VESSEL_TOO_SMALL,        ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USSEG_VESSEL_TOO_SUPERFICIAL,  ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_USSEG_WRONG_ROI,               ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_EMPTY_INPUT,                   ERROR_LEVEL_WARN}
    ,{ERRORCODE_CV_ERROR_UNKNOWN_ERROR,                 ERROR_LEVEL_WARN}
...
inline string ErrorCodeStr(int errorcode)
{
	switch (errorcode)
	{
        ...
        ENUM_NAME_VALUE_FEILD_STR_CASE(ERRORCODE_NIRDEVICE_USBTYPE_USB2,          errorcode, "红外设备接USB2.0");
        ...
        ENUM_NAME_VALUE_FEILD_STR_CASE(ERRORCODE_CV_ERROR_IRSEG_TIEHE_COLLISION,       errorcode, "血管贴合位置有碰撞风险");
